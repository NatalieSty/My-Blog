...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- 
-- Generated on: Thu Feb  8 17:53:06 2018
...
ALTER EXTENSION postgis ADD FUNCTION pgis_geometry_accum_transfn (pgis_abs, geometry, float8, int);
...
ALTER EXTENSION postgis ADD FUNCTION st_makeemptycoverage (tilewidth int, tileheight int, width int, height int, upperleftx float8, upperlefty float8, scalex float8, scaley float8, skewx float8, skewy float8, srid int4 );
