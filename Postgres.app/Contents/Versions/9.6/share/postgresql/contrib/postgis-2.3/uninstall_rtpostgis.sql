...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- 
-- Generated on: Thu Feb  8 17:51:09 2018
...
DROP FUNCTION IF EXISTS ST_BandMetaData (	rast raster,	band int[],	OUT bandnum int,	OUT pixeltype text,	OUT nodatavalue double precision,	OUT isoutdb boolean,	OUT path text);
DROP FUNCTION IF EXISTS ST_BandMetaData (	rast raster,	band int ,	OUT pixeltype text,	OUT nodatavalue double precision,	OUT isoutdb boolean,	OUT path text);
